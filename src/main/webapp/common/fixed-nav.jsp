...
<div class="navbar navbar-default navbar-fixed-top " role="navigation">
	<div class="container">
		<ul class="nav navbar-nav ">
			...
			<bsp:nav url="/security/role!list.action" value="角色管理" />
			<bsp:nav url="/security/user!list.action" value="用户管理" />
			<bsp:nav url="/security/resource!list.action" value="资源管理" />
		</ul>
		<ul class="nav navbar-nav navbar-right">
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<li><a id="navLoginLink" href="${loginUrl}">登录</a>
					</li>
				</c:otherwise>
			</c:choose>
		</ul>
